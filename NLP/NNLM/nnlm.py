'''
http://www.manongjc.com/detail/8-olhdpidvlqovpni.html
'''
...
#sentences = [ "i love milk hello", "i hate beef no", "i guess you are right"]
sentences = [ "i like to milk", "i like eat beef", "i really heat pig"]
#test = ['i like to', 'i like eat', 'i really heat']
