# 从url文本中的超链接提取实体之间的文本，从而获取关系三元组head tail relation
...
symptom = open('classified-merged/pure_names/pure_names_multisource/symptom2_name.txt', 'r', encoding='utf-8')
inspect = open('classified-merged/pure_names/pure_names_multisource/inspection2.txt', 'r', encoding='utf-8')
specialty = open('classified-merged/pure_names/pure_names_multisource/speciaty.txt', 'r', encoding='utf-8')
medic = open('classified-merged/pure_names/pure_names_multisource/medic.txt', 'r', encoding='utf-8')
...
specialty_set = set()
medic_set = set()
sets = [disease_set, drug_set, bacteria_set, virus_set, symptom_set, inspect_set, specialty_set, medic_set]
...
files = os.listdir('classified-merged/classified-merged-json/v1/tmp')[:]
fp1 = open('relationships/relationship_disease_filter2.txt', 'w', encoding='utf-8')
fp2 = open('relationships/relationship_virus_filter2.txt', 'w', encoding='utf-8')
fp3 = open('relationships/relationship_bacteria_filter2.txt', 'w', encoding='utf-8')
fp4 = open('relationships/relationship_drug_filter2.txt','w', encoding='utf-8')
fp5 = open('relationships/relationship_symptom2_filter2.txt','w', encoding='utf-8')
fp6 = open('relationships/relationship_inspection2_filter2.txt','w', encoding='utf-8')
fp7 = open('relationships/relationship_specialty_filter2.txt','w', encoding='utf-8')
fp8 = open('relationships/relationship_medic_filter2.txt','w', encoding='utf-8')
for file in files:
    with open(os.path.join('classified-merged/classified-merged-json/v1/tmp', file), 'r', encoding='utf-8') as f:
        i = f.readline()
        # print(single_file)
